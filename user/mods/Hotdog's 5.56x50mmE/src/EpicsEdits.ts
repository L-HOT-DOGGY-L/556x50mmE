    ...
    public epicEdits(): void {
        ...
        for (let file in dbItems) {
            ...
            if(fileData._id === "5448c1d04bdc2dff2f8b4569") {
                fileData._props.Cartridges[0]._props.filters[0].Filter.push("6737b3c662a03ab20667f02a", "54527ac44bdc2d36668b4567", "54527ac44bdc2d36668b4567");
            }
            ...
            if(fileData._id === "5c07c60e0db834002330051f") {
                fileData._props.Chambers[0]._props.filters[0].Filter.push("6737b3c662a03ab20667f02a"), "54527ac44bdc2d36668b4567", "54527ac44bdc2d36668b4567";
            }
        }
    }
